...
-   **Качество на валидации:** **0.86** Weighted F1-score (метрика рассчитана на автоматически сгенерированных метках, поэтому может отличаться от оценки на реальных данных).
