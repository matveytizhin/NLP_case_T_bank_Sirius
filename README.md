...
-   **Принципы и примеры:** Промпт был усилен главными принципами классификации и большим количеством примеров (включая негативные), чтобы модель лучше понимала логику в сложных случаях (например, "ужасная синтетика" -> "нет товара" (слишком много категорий подходят для такого описания), но "низ рваный" -> "одежда" (у обуви рваная подошва, в текстиле написали бы что просто рваная ткань, подушка и тд, а вот в категории одежда - рваные снизу джинсы, платье и тд очень даже уместно написать)).
